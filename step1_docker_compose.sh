#!/bin/bash
# STEP 1: Write fresh docker-compose.yml
...
python3 -c "import yaml; yaml.safe_load(open('docker-compose.yml')); print('[✔] YAML is valid')" 2>/dev/null || echo "[!] python3-yaml not installed — skipping validation"
